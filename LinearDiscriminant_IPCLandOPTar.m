function [trainedClassifier, validationAccuracy] = LinearDiscriminant_IPCLandOPTar(trainingData,decodedItem)
...
% 以下代码指定所有分类器选项并训练分类器。
if decodedItem == 1
    ClassNames = {'TR';'TL';'BL';'BR'};
elseif decodedItem == 2
    ClassNames = {'IA';'IB';'IIA';'IIB';'IIIA';'IIIB';'IVA';'IVB'};
